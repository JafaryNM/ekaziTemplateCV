// Template2.jsx — uses moment for all date formatting
  ...
  return (
    <div className="container my-4">
              ...
              <Section title="Education">
                {education.length ? (
                  education
                    .slice()
                    .sort((a, b) => {
                      const bKey = moment(b?.ended || b?.end_date);
                      const aKey = moment(a?.ended || a?.end_date);
                      return (
                        (bKey.isValid() ? bKey.valueOf() : 0) -
                        (aKey.isValid() ? aKey.valueOf() : 0)
                      );
                    })
                    .map((edu, i) => (
      ...
      <style>{`
        ...
        .fs-5 { text-align: center; padding: 30px 30px; }
        .photoOctagon {
        ...
        .photoOctagonImg { width:170px; height:170px; object-fit:cover; border-radius:10px; }
