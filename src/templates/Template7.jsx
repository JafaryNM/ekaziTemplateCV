  ...
  return (
    ...
    >
      ...
      <style>{`
        ...
        /* Make only left-rail SVGs white */
        .rail svg {
          color: #ffffff !important;
          stroke: #ffffff !important;
        }
        /* Tighten headings and ensure white text */
        .rail h6.mb-0 {
          color: #ffffff !important;
          letter-spacing: .2px;
        }
        /* Subtext and lists in the rail */
        .rail .small,
        .rail p,
        .rail li {
          color: rgba(255,255,255,0.85) !important;
        }
        /* Divider line in rail groups */
        .rail .rail-divider {
          height: 1px;
          background: linear-gradient(90deg, rgba(255,255,255,.12), rgba(255,255,255,.04));
          margin: 14px 0;
        }
        /* Chip hover polish (rail only) */
        .rail .chip:hover {
