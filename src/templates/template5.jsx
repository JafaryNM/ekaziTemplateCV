...
export default function Template5() {
  ...
  // ---------- extract safely (match Template1 style) ----------
  ...
  // Prefer profile email if present; fallbacks to user/email block
  const primaryEmail =
  ...
  // ---------- Experience (Template1 parity: sort + bullets + location/industry) ----------
  ...
  // ---------- Side “skills chips” from knowledge ----------
  ...
  return (
    ...
    >
              ...
              <ul className="list-unstyled small mb-0">
                {eduVM.map((edu, i) => (
                  <li key={i} className="mb-2">
                    <div className="fw-semibold">{edu.course}</div>
                    <div className="text-muted">{edu.school}</div>
      ...
      <style>{`
        body { font-family: "Nunito", system-ui, -apple-system, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Apple Color Emoji","Segoe UI Emoji","Segoe UI Symbol","Noto Color Emoji", sans-serif; }
        ...
        /* Keep photo strictly 150x180 without touching all img.border */
